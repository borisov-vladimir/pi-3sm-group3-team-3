...
def test_get_list_passangers_where_name_starts_with_text_survived_is_false_and_true():
    ...
    assert get_result(data, 'B') == [{'Возраст': '22', 'Имя': '"Braund Mr. Owen Harris"', 'Класс': '3'}]
...
def test_get_list_passangers_where_name_starts_with_text():
    ...
    assert get_result(data, 'Asplund') == [{'Возраст': '38', 'Имя': '"Asplund Mrs. Carl Oscar (Selma Augusta Emilia Johansson)"', 'Класс': '3'}]
...
def test_get_list_passangers_where_all_name_starts_with_text_where_all_survived():
    ...
    assert get_result(data, 'B') == [{'Возраст': '22', 'Имя': '"Braund Mr. Owen Harris"', 'Класс': '3'}, {'Возраст': '54', 'Имя': '"BcCarthy Mr. Timothy J"', 'Класс': '1'}]
